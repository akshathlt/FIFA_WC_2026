      ...
      {player && !player.is_admin && myRank > 0 && (
        <div className="mt-6 card p-5">
          ...
          <p className="text-xs text-slate-500 text-center mb-4">
            You're ranked <strong className="text-green-400">#{myRank}</strong> out of {players.length} players with <strong className="text-yellow-400">{myPts} pts</strong>
          </p>
          <div className="flex gap-2 justify-center flex-wrap">
            {/* LinkedIn */}
            <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://akshathlt.github.io/wc2026-predictor/')}&summary=${encodeURIComponent(`I'm ranked #${myRank} out of ${players.length} in our WC2026 Office Predictor with ${myPts} pts! 🏆⚽ Join the game: https://akshathlt.github.io/wc2026-predictor/`)}`}
            ...
            {/* Twitter/X */}
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`I'm ranked #${myRank} out of ${players.length} in our WC2026 Office Predictor with ${myPts} pts! 🏆⚽ #WorldCup2026 #WC2026`)}&url=${encodeURIComponent('https://akshathlt.github.io/wc2026-predictor/')}`}
              target="_blank" rel="noopener noreferrer"
            ...
            {/* Facebook */}
            <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://akshathlt.github.io/wc2026-predictor/')}&quote=${encodeURIComponent(`I'm ranked #${myRank} in our WC2026 Office Predictor! 🏆⚽`)}`}
              target="_blank" rel="noopener noreferrer"
            ...
            <a href={`https://www.instagram.com/`}
              target="_blank" rel="noopener noreferrer"
              title="Copy your ranking text then paste on Instagram"
              onClick={() => { navigator.clipboard?.writeText(`I'm ranked #${myRank} out of ${players.length} in our WC2026 Office Predictor with ${myPts} pts! 🏆⚽ #WorldCup2026 https://akshathlt.github.io/wc2026-predictor/`) }}
          ...
          <p className="text-xs text-slate-600 text-center mt-2">Instagram: copies text to clipboard — paste in your story!</p>
        </div>
      )}
    </div>
  )
